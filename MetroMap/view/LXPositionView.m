...
static NSInteger const pulsingCount = 1;
...
- (CAKeyframeAnimation *)backgroundColorAnimation {
    ...
    if(_backgroundColors && _backgroundTimes && _backgroundTimes.count>0 && _backgroundTimes.count==_backgroundColors.count){
        backgroundColorAnimation.values = _backgroundColors;
        backgroundColorAnimation.keyTimes = _backgroundTimes;
    }else{
...
- (CAKeyframeAnimation *)borderColorAnimation {
    ...
    if(_borderColors && _borderTimes && _borderTimes.count>0 && _borderTimes.count==_borderTimes.count){
        borderColorAnimation.values = _borderColors;
        borderColorAnimation.keyTimes = _borderTimes;
    }else{
